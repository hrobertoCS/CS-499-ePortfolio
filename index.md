...
My name is Roberto Hernandez and I am completing my Bachelor of Science in Computer Science at Southern New Hampshire University with a concentration in Software Engineering. Throughout this program, I have learned how computer science concepts come together to create complete software solutions. The CS499 coursework and the development of my ePortfolio have helped me identify my strengths in software development and application design. They have also helped shape my professional goal of becoming a software engineer.

Developing my ePortfolio allowed me to reflect on the growth I have made throughout the Computer Science program. Early in the program, many of my projects focused on developing individual software components but as I progressed through the program, I gained experience building full-stack applications that combine user interfaces, application logic, and databases. Courses involving software development, data structures and algorithms, databases, and security helped me learn how each area of computer science contributes to creating applications.

Several courses throughout the program helped me build skills outside of the artifacts included in my ePortfolio. In CS300 I became familiar with data structures and how choosing the right data structure can change the efficiency of a program. Another course that was helpful in preparing me to build full-stack applications and shaped my professional goals was CS340 where I learned to work with databases and developed an application that allowed me to read and write stored data. The experience that I gained from these courses was a key part in building the skills necessary to work on my enhancements. 

This program has prepared me for my future work in software engineering where I will use the skills I’ve learned to collaborate in a team environment and participate in iterative design over the course of a software development lifecycle. I will use what I have learned to communicate with stakeholders and regularly report updates on the progress being made in development as well as any constraints that may be arising as obstacles.  I will use the skills I’ve learned in data structures and algorithms to build efficient and scalable applications using algorithmic thinking as well as choosing the appropriate data structures for the tasks at hand. I will ensure that my programs are cohesive and follow industry standards by following recommended software design principles and evaluating different solutions in order to understand the trade-offs involved in software design. Keeping security at the forefront of development will ensure that there are defense layers that address vulnerabilities and potential exploits as part of an overall system of Defense in Depth. This security mindset throughout development will prevent vulnerabilities and exploits from being embedded into core program functionality and that they are addressed as early as possible before they become costly or time consuming to fix. 

My artifacts fit together to showcase the skills I have learned and how I have applied these skills to building MacroTrackerRPG. The Software Design and Engineering artifact I chose was enhanced to improve the React Native application structure with reusable components and shared state management with React Context. The enhancement also focused on ensuring the application was responsive across different devices. The Algorithms and Data Structures artifact I chose was enhanced to improve the progression system and extract progression rules from the XP calculation. This enhancement also involved porting the original Python prototypes into TypeScript and evaluating the efficiency of the algorithm using big O notation. The Database artifact I chose was enhanced to expand the original SQLite prototype into a relational database that connected the character and nutrition data and added input validation and parameterized queries as defense layers to protect against SQL injection or the data being corrupted silently in the database after storing invalid inputs. These artifacts and their enhancements demonstrate my ability to take several different computer science concepts that I have learned throughout my program and fit them together to make a functional application. 
...
4.	Did you meet the course outcomes you planned to meet with this enhancement in Module One? Do you have any updates to your outcome-coverage plans?
...
5. Reflect on the process of enhancing and modifying the artifact. What did you learn as you were creating it and improving it? What challenges did you face?
...
The artifact I chose for this enhancement is the macro database Python file for MacroTrackerRPG. It uses SQLite to store user daily macros and contains functions to save daily logs and retrieve past logs. I created this artifact earlier this year. 
